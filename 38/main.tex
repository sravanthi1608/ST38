...
\item Using the Poisson probability formula,\\
 \begin{align}
 pr{N(t)=k} = \frac{k!(\lambda t)^k e^{-\lambda t}}{k!} \\
  \end{align}
 here $\lambda$ is 1 \\
 \begin{align}
 pr\brak{N(t)=k} = \frac{k!(t)^k e^{-t}}{k!}\\
 pr\brak{N(3)=3} = \frac{3!(3)^3 e^{-3}}{3!}\\
 pr\brak{N(5)=5} = \frac{5!(5)^5 e^{-5}}{5!}
 \end{align}
 From conditional probability,
 \begin{align}
 pr\brak{N(k)=k|N(n)=n}&=\frac{\frac{k!(k)^k e^{-k}}{k!}\frac{(n-k)!(n-k)^{n-k} e^{-(n-k)}}{(n-k)!}}{\frac{n!(n)^n e^{-n}}{n!}}
  \end{align}
  \begin{align}
 pr\brak{N(3)=3|N(5)=5}&=\frac{\frac{3!(3)^3 e^{-3}}{3!}\frac{2!(2)^2 e^{-2}}{2!}}{\frac{5!(5)^5 e^{-5}}{5!}}\\
