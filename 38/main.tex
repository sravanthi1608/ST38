...
\item $P(N(3)=3|N(5)=5)=\comb{5}{3}\left(\frac{3}{5}\right)^3 \left(\frac{2}{5}\right)^2$
...
\item Using the Poisson probability formula,\\
 \begin{align}
 P(N(t)=k) = \frac{k!(\lambda t)^k e^{-\lambda t}}{k!} \\
  \end{align}
 here $\lambda$ is 1 \\
 \begin{align}
 P(N(t)=k) = \frac{k!(t)^k e^{-t}}{k!}\\
 P(N(3)=3) = \frac{3!(3)^3 e^{-3}}{3!}\\
 P(N(5)=5) = \frac{5!(5)^5 e^{-5}}{5!}
 \end{align}
 From conditional probability,
 \begin{align}
 P(N(3)=3|N(5)=5)&=\frac{\frac{3!(3)^3 e^{-3}}{3!}\frac{2!(2)^2 e^{-2}}{2!}}{\frac{5!(5)^5 e^{-5}}{5!}}\\
