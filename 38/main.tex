...
\item Using the Poisson probability formula,\\
 \begin{align}
 pr\brak{N(t)=k} =Po(t;k) =\frac{(\lambda t)^k e^{-\lambda t}}{k!} 
  \end{align}
 here $\lambda$ is 1 
 \begin{align}
 ...
 \begin{align}
 pr\brak{X=k,X+Y=n}&=pr\brak{X=k,Y=n-k}\\
 &=\frac{t_1^k}{k!}e^{-t_1}\frac{t_2^{n-k}}{(n-k)!}e^{-t_2}\\
 &=e^{-(t_1+t_2)}\left(\frac{(t_1+t_2)^n}{n!}\right)\comb{n}{k}\left(\frac{(t_1)}{t_1+t_2}\right)^k\left(\frac{(t_2)}{t_1+t_2}\right)^{n-k}
 \end{align}
 \begin{align}
  pr\brak{X+Y=n}=e^{-(t_1+t_2)}\left(\frac{(t_1+t_2)^n}{n!}\right)
 \end{align}
  From conditional probability,
 \begin{align}
 pr\brak{X=k|X+Y=n}&=\frac{pr\brak{X=k,Y=n-k}}{pr\brak{X+Y=n}}\\
 &=\comb{n}{k}\left(\frac{(t_1)}{t_1+t_2}\right)^k\left(\frac{(t_2)}{t_1+t_2}\right)^{n-k}
 \end{align} 
 For the given question,
 \begin{align}
 pr\brak{N(3)=3|N(5)=5}&=\comb{5}{3}\left(\frac{3}{2+3}\right)^3\left(\frac{2}{2+3}\right)^{2}\\
